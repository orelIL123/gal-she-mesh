...
with_node \
  ...
  --target "/Users/x/Documents/BARBERAPP/barber_app/ios/Pods/Target Support Files/Pods-RonTurgeman/ExpoModulesProvider.swift" \
  --entitlement "/Users/x/Documents/BARBERAPP/barber_app/ios/RonTurgeman/RonTurgeman.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-notifications" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-updates" "expo-web-browser"
