...
const SideMenu: React.FC<SideMenuProps> = ({ visible, onClose, onNavigate, onNotificationPress }) => {
  ...
  const aboutText = `ברוכים הבאים למספרה של Naor Amar! כאן תיהנו מחוויה אישית, מקצועית ומפנקת, עם יחס חם לכל לקוח. נאור עמר, ספר מקצועי עם שנות ניסיון, מזמין אתכם להתרווח, להתחדש ולהרגיש בבית.\n\n✂️ AI: "המספרה שלנו היא לא רק מקום להסתפר, אלא מקום להרגיש בו טוב, להירגע ולצאת עם חיוך. כל תספורת היא יצירת אמנות!"`;
      ...
      >
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.85)', justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ backgroundColor: '#111', borderRadius: 16, padding: 24, maxWidth: 340, alignItems: 'center' }}>
            ...
            <TouchableOpacity onPress={() => setShowAbout(false)} style={{ backgroundColor: '#ffd700', borderRadius: 8, paddingHorizontal: 24, paddingVertical: 12 }}>
