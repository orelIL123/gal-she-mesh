...
const termsText = `תנאי שימוש באפליקציה – Naor Amar

ברוך הבא לאפליקציית ניהול התורים של Naor Amar. השימוש באפליקציה מעיד על הסכמתך המלאה לתנאים אלו.
...
2. על האפליקציה
האפליקציה משמשת לניהול וזימון תורים לעסקים. היא מופעלת ומתוחזקת באופן עצמאי על-ידי Naor Amar.
...
ייתכנו תקלות או זמינות מוגבלת. Naor Amar אינו אחראי לנזק עקיף או ישיר.
...
7. קניין רוחני
כל הזכויות על העיצוב, הפיתוח והתוכן באפליקציה שייכות ל-Naor Amar.
...
9. שינוי תנאים
Naor Amar שומר לעצמו את הזכות לעדכן את תנאי השימוש ללא הודעה מוקדמת.
10. יצירת קשר
לשאלות או פניות:
✉️ naor@naoramar.com
📞 053-270-6369`;
