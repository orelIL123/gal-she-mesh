...
const AdminSettingsScreen: React.FC<AdminSettingsScreenProps> = ({ onNavigate, onBack }) => {
  ...
  const [subtitleMessage, setSubtitleMessage] = useState('ל-Naor Amar ברברשופ');
  const [aboutUsText, setAboutUsText] = useState('ברוכים הבאים למספרה של Naor Amar! כאן תיהנו מחוויה אישית, מקצועית ומפנקת, עם יחס חם לכל לקוח. נאור עמר, ספר מקצועי עם שנות ניסיון, מזמין אתכם להתרווח, להתחדש ולהרגיש בבית.');
  ...
  const loadSettings = async () => {
    try {
      ...
      if (welcomeDoc.exists()) {
        ...
        setSubtitleMessage(data.subtitle || 'ל-Naor Amar ברברשופ');
      } else {
      ...
      if (aboutDoc.exists()) {
        ...
        // Create default if doesn't exist
        const defaultAboutText = 'ברוכים הבאים למספרה של Naor Amar! כאן תיהנו מחוויה אישית, מקצועית ומפנקת, עם יחס חם לכל לקוח. נאור עמר, ספר מקצועי עם שנות ניסיון, מזמין אתכם להתרווח, להתחדש ולהרגיש בבית.';
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholder="ל-Naor Amar ברברשופ"
              textAlign="right"
              multiline
            />
          </View>
