...
function HomeScreen({ onNavigate, isGuestMode = false }: HomeScreenProps) {
  ...
  const fetchDynamicContent = async () => {
    try {
      ...
      if (aboutDoc.exists()) {
        ...
        setAboutUsMessage(data.text || 'ברוכים הבאים למספרה של Naor Amar! כאן תיהנו מחוויה אישית, מקצועית ומפנקת, עם יחס חם לכל לקוח. נאור עמר, ספר מקצועי עם שנות ניסיון, מזמין אתכם להתרווח, להתחדש ולהרגיש בבית.');
      } else {
        setAboutUsMessage('ברוכים הבאים למספרה של Naor Amar! כאן תיהנו מחוויה אישית, מקצועית ומפנקת, עם יחס חם לכל לקוח. נאור עמר, ספר מקצועי עם שנות ניסיון, מזמין אתכם להתרווח, להתחדש ולהרגיש בבית.');
      }
  ...
  const handlePhoneCall = () => {
    Linking.openURL('tel:+9720532706369').catch(() => {
      Alert.alert(t('common.error'), t('errors.phone_error'));
    });
  };

  const handleWhatsApp = () => {
    Linking.openURL('https://wa.me/9720532706369').catch(() => {
  ...
  const handleSocialMedia = (platform: string) => {
    ...
    switch (platform) {
      case 'facebook':
        url = 'https://www.facebook.com/naoramar15';
        break;
      case 'instagram':
        url = 'https://www.instagram.com/naoramar15';
        break;
      default:
        return;
    }
        ...
        <View style={styles.contentWrapper}>
          ...
          <Animated.View style={[styles.quickActionsSection, { opacity: ctaFade }]}>
            ...
            <View style={styles.quickActionsGrid}>
              ...
              >
                <Ionicons name="list" size={32} color="#ffd700" />
            ...
            <View style={styles.aboutCard}>
              ...
              <View style={styles.aboutContent}>
                <Text style={styles.aboutText}>
                  {aboutUsMessage || `ברוכים הבאים למספרה של Naor Amar! כאן תיהנו מחוויה אישית, מקצועית ומפנקת, עם יחס חם לכל לקוח. נאור עמר, ספר מקצועי עם שנות ניסיון, מזמין אתכם להתרווח, להתחדש ולהרגיש בבית. 
          ...
          <Animated.View style={[styles.contactSection, { opacity: cardsFade }]}>
            ...
            <View style={styles.contactGrid}>
              <TouchableOpacity style={styles.contactCard} onPress={handlePhoneCall}>
                <Ionicons name="call" size={32} color="#ffd700" />
