...
const styles = StyleSheet.create({
  ...
  emptyAddButton: { backgroundColor: '#ffd700', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 8 },
  ...
  editHint: { fontSize: 12, color: '#ffd700', textAlign: 'right' },
  ...
  selectedTimeSlot: { backgroundColor: '#ffd700', borderColor: '#ffd700' },
  ...
  debugText: { fontSize: 14, color: '#ffd700', textAlign: 'center', marginBottom: 10, backgroundColor: '#f0f8ff', padding: 8, borderRadius: 4 },
  dayCard: {
    backgroundColor: '#fff', borderRadius: 12, padding: 16, marginBottom: 12,
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3,
  },
  dayTitleContainer: { backgroundColor: '#f8f9fa', borderRadius: 8, padding: 12, marginBottom: 12, borderLeftWidth: 4, borderLeftColor: '#ffd700' },
  dayTitle: { fontSize: 20, fontWeight: 'bold', color: '#ffd700', textAlign: 'center' },
  ...
  selectedCount: { fontSize: 14, color: '#ffd700', fontWeight: '600', textAlign: 'center', marginTop: 12, padding: 8, backgroundColor: '#e3f2fd', borderRadius: 6 },
  dayNameHeader: { backgroundColor: '#ffd700', borderRadius: 8, padding: 16, marginBottom: 16, alignItems: 'center' },
