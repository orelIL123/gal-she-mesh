// Employee/Barber Seed Data for naor amar
...
export const employeeSeedData = {
  ...
  employees: [
    {
      id: "barber_1",
      userId: "user_naor_amar_barber_1",
      name: "apiKey: "AIzaSyATvhrRnzKXrww0ZuvrwcSei9C8Ik1zeAM",",
      phone: "+9720532706369",
      ...
      isMainBarber: true,
      available: true,
      bio: "מספר מקצועי עם ניסיון של 10 בתחום תספורת גברים",
      rating: 4.8,
      specialties: ['תספורת גברים'],
      availableSlots: [
