...
const termsText = `תנאי שימוש באפליקציה – גל שמש

ברוך הבא לאפליקציית ניהול התורים של גל שמש. השימוש באפליקציה מעיד על הסכמתך המלאה לתנאים אלו.
...
2. על האפליקציה
האפליקציה משמשת לניהול וזימון תורים לעסקים. היא מופעלת ומתוחזקת באופן עצמאי על-ידי גל שמש.
...
ייתכנו תקלות או זמינות מוגבלת. גל שמש אינו אחראי לנזק עקיף או ישיר.
...
7. קניין רוחני
כל הזכויות על העיצוב, הפיתוח והתוכן באפליקציה שייכות לגל שמש.
...
9. שינוי תנאים
גל שמש שומר לעצמו את הזכות לעדכן את תנאי השימוש ללא הודעה מוקדמת.
10. יצירת קשר
לשאלות או פניות:
