...
const termsText = `תנאי שימוש באפליקציה – torix

ברוך הבא לאפליקציית ניהול התורים של torix. השימוש באפליקציה מעיד על הסכמתך המלאה לתנאים אלו.
...
2. על האפליקציה
האפליקציה משמשת לניהול וזימון תורים לעסקים. היא מופעלת ומתוחזקת באופן עצמאי על-ידי אוראל אהרון.
...
ייתכנו תקלות או זמינות מוגבלת. torix אינו אחראי לנזק עקיף או ישיר.
...
7. קניין רוחני
כל הזכויות על העיצוב, הפיתוח והתוכן באפליקציה שייכות ל־torix.
...
9. שינוי תנאים
torix שומר לעצמו את הזכות לעדכן את תנאי השימוש ללא הודעה מוקדמת.
10. יצירת קשר
לשאלות או פניות:
